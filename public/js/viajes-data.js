...
window.VIAJES = [
  {
    ...
    incluye: [
        ...
        "Hakone: paseo en barco por el lago Ashi con vistas al Monte Fuji (sujeto al clima), Valle de Owakudani y Museo al aire libre",
        "Kyoto: Templo Kinkaku-ji (Pabellón dorado), Santuario Fushimi Inri, Bosque de Bambú de Arashiyama, Barrio de Gion",
        "Nara: Templo Todaji, Buda gigante y Parque de los ciervos",
...

  {
    ...
    precio: 4710,
    tipo: "Viaje grupal acompañado",
    descripcion: "Un recorrido por el corazón cultural de Europa.",
    incluye: [
        ...
        "Excursion Roma Antigua” o “Roma Imprescindible” incluye cena",
        "Visita y con Almuerzo en Florencia",
...

  {
    ...
    incluye: [
        ...
        "Vuelo interno Viena - Madrid",
        "Traslados Aeropuerto/Hotel/Aeropuerto en todas las ciudades del recorrido",
        "10 noches de alojamiento en hoteles seleccionados con desayuno diario tipo Buffet",
        "3 noches en Madrid",
        "Transporte en autobús turístico durante todo el circuito, con guía acompañante",
...

  {
    ...
    precio: 6500,
    tipo: "Viaje grupal acompañado",
    descripcion: "Grecia en temporada ideal, con acompañamiento desde Uruguay.",
    incluye: [
...

  {
    ...
    precio: 4920,
    tipo: "Viaje grupal acompañado",
    descripcion: "Oriente y modernidad en un recorrido completo.",
    incluye: [
        "Vuelos Montevideo /Turquia y Dubai",
        "1 tarde de alojamiento en San Pablo",
        "Todos los Traslados aeropuerto/hotel en Estambul y Dubai",
