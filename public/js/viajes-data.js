  ...
  ==============================*/
{
    ...
    "Coordinador acompañante desde Montevideo (con mínimo de pasajeros)",
...

  {
    ...
    precio: 4850,
    tipo: "Viaje grupal acompañado",
    descripcion: "Un viaje para descubrir Europa en su máxima expresión: ciudades icónicas, paisajes inolvidables y culturas que marcan historia en cada paso.",
    incluye: [
        "Vuelos internacionales",
        "Traslados aeropuerto / hotel / aeropuerto",
        "Coordinador acompañante desde Montevideo con minimo de pasajeros",
        "Alojamiento en hoteles seleccionados con desayuno diario",
        "Recorrido completo en bus por Europa",
        "Ferry Dover – Calais (Inglaterra – Francia)",
        "Transporte terrestre durante todo el circuito",
        ...
        "Visitaremos Inglaterra, Francia, Bélgica y Países Bajos, Alemania y República Checa, Italia (Venecia, Roma, Florencia, Pisa), Costa Azul, España (Barcelona, Zaragoza y Madrid)",
        "Haremos paradas en ciudades icónicas como Brujas, Colonia, Frankfurt, Verona e Innsbruck",
        "Experiencias destacadas como Recorrido por el Valle del Rin, Paseo por ciudades medievales como Rotemburgo, Visita a la Torre de Pisa, Recorrido por la Riviera Francesa",
        "Seguro de viaje",
    ],
...

  {
    ...
    incluye: [
        "Vuelos internacionales",
        "Coordinador acompañante desde Montevideo con un mínimo de pasajeros",
        "Traslados aeropuerto / hotel / aeropuerto",
...

  {
    ...
    incluye: [
        "Vuelos internacionales",
        "Coordinador acompañante desde Montevideo con un minimo de pasajeros",
        "Traslados aeropuerto / hotel / aeropuerto",
  ...
  {
    id: "amalfi-puglia",
    titulo: "Costa Amalfitana y La Puglia",
    imagenes: [
      "/img/amalfi1.jpeg",
      "/img/amalfi2.jpeg",
      "/img/amalfi3.jpeg",
    ...
    duracion: "17 días",
    salida: "Setiembre 2027",
    precio: 8090,
    tipo: "Viaje grupal acompañado",
    descripcion: "Un viaje para enamorarse del sur de Italia: pueblos colgados al mar, sabores inolvidables y paisajes que parecen sacados de una película.",
    incluye: [
        "Vuelos internacionales",
        "Traslados aeropuerto / hotel / aeropuerto",
        "Alojamiento en hoteles seleccionados con desayuno diario",
        "Coordinador acompañante desde MVD con minimo de pasajeros",
        "Bus de lujo durante todo el circuito",
        "Crucero por el Lago di Garda",
        "Barco en Venecia recorriendo las islas de la laguna",
        "Ferry Nápoles – Capri – Sorrento",
        "Crucero costero por la Costa Amalfitana (Positano y Amalfi)",
        "3 cenas",
        "3 almuerzos",
        "Cena especial con música en Roma",
        "Recorrido completo por Milán, Verona, Venecia, Florencia y Roma",
        "Paseo por el barrio del Trastevere en Roma",
        "Visita a Capri con paseo en barco por sus costas",
        "Visita a Pompeya y Nápoles",
        "Descubrimiento de Matera y sus “Sassi”",
        "Recorrido por la Puglia: Alberobello, Lecce, Ostuni, Polignano a Mare y Bari",
        "Excursión por el “tacón de Italia” hasta Santa María de Leuca",
        "Entradas incluidas a la Catedral de Amalfi y Excavaciones de Pompeya",
        "Paseo en góndola en Venecia",
        "Visita a la Iglesia de Santa Croce en Florencia",
        "Visita a la Roma Barroca",
        "Museos Vaticanos y Capilla Sixtina",
    ],
    pdf: "/pdfs/amalfipuglia-setiembre.pdf",
    whatsappText: "Hola! Quiero consultar por el viaje a Costa Amalfitana y La Puglia"
  },
